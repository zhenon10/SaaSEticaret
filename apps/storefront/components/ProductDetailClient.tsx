...
export default function ProductDetailClient({ product, whatsappPhone, productUrl }: Props) {
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="grid gap-8 lg:grid-cols-3">
        ...
        <div className="space-y-6 lg:col-span-2">
          ...
          {/* Favoriler, Paylaş ve Satıcıya Sor */}
          <div className="flex flex-wrap items-center gap-6 pt-2 pb-4">
            ...
            {whatsappPhone && (
              <a
                href={`https://wa.me/${whatsappPhone}?text=${encodeURIComponent(`Merhaba! Şu ürün hakkında bilgi almak istiyorum:\n\n${product.name}\n${productUrl ?? window.location.href}`)}`}
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-[#25D366] hover:text-[#1ebe5d] transition-colors"
              >
